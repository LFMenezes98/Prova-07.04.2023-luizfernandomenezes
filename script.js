...
for(let i = 0; i < alunos.length; i++) {
    ...
    if (aluno.ra == ra){
       ...
       document.getElementById('cidade').value = aluno.cidade
        ...
        document.getElementById('beijo').value = aluno.beijo
        document.getElementById('gato').value = aluno.gato
        alunoAlterado = aluno
    }
}
...
function salvar() {
    ...
    let beijo = document.getElementById("beijo").value;
...
//se não estiver alterando ninguem, adiciona no vetor
    ...
    alunoAlterado.beijo = beijo
    alunoAlterado.gato = gato
}
...
function limparForm(){
    ...
    document.getElementById('beijo').value = ""
